...
export class Home extends Component {
  ...
  render () {
    return (
        ...
        <p>A prototype is required for you to show your abilities with the most used technologies at Coretex. The challenge is to design a Vehicle Management System that allows the user to create, update and delete vehicles from it.
